...
return {
  keys = {
    ...
    { key = 'J', mods = 'ALT|CTRL', action = act.AdjustPaneSize{ 'Up', 1 } },
    { key = 'K', mods = 'CTRL', action = act.ActivatePaneDirection 'Down' },
    { key = 'K', mods = 'ALT|CTRL', action = act.AdjustPaneSize{ 'Down', 1 } },
    ...
    { key = 'c', mods = 'CTRL', action = act.EmitEvent 'user-defined-0' },
